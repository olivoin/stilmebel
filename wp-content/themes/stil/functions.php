...
function woocommerce_template_loop_product_thumbnail(){
    ...
    echo '
        <div class="margin-b-10">
            <a href="' . $product_link . '">
                <div class="katalog-product-image"> ' . $product_img . ' </div>
            </a>
        </div>   
    ';
}
...
add_filter('woocommerce_single_product_summary', 'woocommerce_single_product_social', 30, 3);

function woocommerce_single_product_social() {
    echo '
        <div data-background-alpha="0.0" data-buttons-color="#ffffff" data-counter-background-color="#ffffff" data-share-counter-size="12" data-top-button="false" data-share-counter-type="common" data-share-style="1" data-mode="share" data-like-text-enable="false" data-mobile-view="false" data-icon-color="#ffffff" data-orientation="horizontal" data-text-color="#000000" data-share-shape="round" data-sn-ids="fb.vk.tw.ok." data-share-size="30" data-background-color="#ffffff" data-preview-mobile="false" data-mobile-sn-ids="fb.vk.tw.wh.ok.vb." data-pid="1559512" data-counter-background-alpha="1.0" data-following-enable="false" data-exclude-show-more="false" data-selection-enable="true" class="uptolike-buttons" ></div>
    ';
}
