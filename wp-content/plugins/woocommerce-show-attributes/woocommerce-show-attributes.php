						...
						if ( $attribute['is_taxonomy'] ) {
							...
							if ( ! empty( $terms ) ) {
								if ( ! is_wp_error( $terms ) ) {
									...
									if ( $hide_labels != 'yes' ) {
										$out_middle .= '<div class="attribute-label">' . sprintf( __( '%s', 'woocommerce-show-attributes' ), $tax_label ) . '' . $colon . ' </div> ';
									}
									$out_middle .= '<div class="attribute-value">';
